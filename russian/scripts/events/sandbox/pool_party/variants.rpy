...
translate russian pool_party_favorite_shows_18c2503d:
...
translate russian pool_party_favorite_shows_67b2660a:
...
translate russian pool_party_favorite_shows_f8a85c91:
...
translate russian pool_party_favorite_shows_de111d11:
...
translate russian pool_party_favorite_shows_fe27da87:
...
translate russian pool_party_favorite_foods_1ad8383f:
...
translate russian pool_party_favorite_foods_77ebd665:

    # "Things get quite heated. . ."
    ""

# game/scripts/events/sandbox/pool_party/variants.rpy:126
translate russian pool_party_favorite_foods_d43f7ed1:
...
translate russian pool_party_sportsball_game_c27215c8:
...
translate russian pool_party_sportsball_game_678a7d57:
...
translate russian pool_party_sportsball_game_a3eda442:
...
translate russian pool_party_sportsball_game_44c84c72:
...
translate russian pool_party_sportsball_game_5f8bb9bf:
...
translate russian pool_party_childhood_story_dcbb436b:
...
translate russian pool_party_mutant_protocols_d0489f88:
...
translate russian pool_party_mutant_protocols_20b34862:
...
translate russian pool_party_mutant_protocols_d91c3e6a:
...
translate russian pool_party_politics_2bc04fa8:
...
translate russian pool_party_politics_bea6f689:
...
translate russian pool_party_politics_0867aff2:
...
translate russian pool_party_inevitable_mortality_d0cbea29:
...
translate russian pool_party_inevitable_mortality_71d5d44a:
...
translate russian pool_party_inevitable_mortality_32f3f46b:
...
translate russian pool_party_inevitable_mortality_4b24016a:
...
translate russian pool_party_inevitable_mortality_a34a0006:
...
translate russian pool_party_sunbathing_1382286b:
...
translate russian pool_party_sunbathing_9e036f5a:
...
translate russian pool_party_sunbathing_e10782bc:
...
translate russian pool_party_sunbathing_74e9d0f6:
...
translate russian pool_party_sunbathing_b165779f:
...
translate russian pool_party_floaties_4a8549df:
...
translate russian pool_party_floaties_930f4c77:
...
translate russian pool_party_floaties_77a30eb3:
...
translate russian pool_party_floaties_74e9d0f6:

    # "Some people were more enthusiastic than others, and not everybody was so keen on laying down to relax with the party going on around them. . ."
    ""

# game/scripts/events/sandbox/pool_party/variants.rpy:357
translate russian pool_party_floaties_b165779f:

    # "They stick around for the sake of the group, but you can tell some would have rather burnt off their excess energy."
    ""

# game/scripts/events/sandbox/pool_party/variants.rpy:381
translate russian pool_party_dip_feet_4d527bcb:
...
translate russian pool_party_dip_feet_96efbb2a:
...
translate russian pool_party_dip_feet_c6fc9b16:
...
translate russian pool_party_dip_feet_74e9d0f6:

    # "Some people were more enthusiastic than others, and not everybody was so keen on laying down to relax with the party going on around them. . ."
    ""

# game/scripts/events/sandbox/pool_party/variants.rpy:390
translate russian pool_party_dip_feet_b165779f:

    # "They stick around for the sake of the group, but you can tell some would have rather burnt off their excess energy."
    ""

# game/scripts/events/sandbox/pool_party/variants.rpy:414
translate russian pool_party_marco_polo_e8838694:
...
translate russian pool_party_marco_polo_e7b1fe97:
...
translate russian pool_party_marco_polo_b7b7e7d0:
...
translate russian pool_party_marco_polo_4de135f2:
...
translate russian pool_party_marco_polo_cb133028:
...
translate russian pool_party_marco_polo_746fcabf:
...
translate russian pool_party_chicken_fight_36d1a2a4:
...
translate russian pool_party_chicken_fight_d966745c:
...
translate russian pool_party_chicken_fight_0d933fb2:
...
translate russian pool_party_chicken_fight_50f32046:
...
translate russian pool_party_chicken_fight_cb133028:

    # "Some people were more enthusiastic than others, and not everybody was so keen on splashing around expending so much energy. . ."
    ""

# game/scripts/events/sandbox/pool_party/variants.rpy:474
translate russian pool_party_chicken_fight_746fcabf:

    # "They stick around for the sake of the group, but you can tell some would have rather relaxed and saved their energy."
    ""

# game/scripts/events/sandbox/pool_party/variants.rpy:498
translate russian pool_party_pool_volleyball_807721e9:
...
translate russian pool_party_pool_volleyball_8f376453:
...
translate russian pool_party_pool_volleyball_f2fed00f:
...
translate russian pool_party_pool_volleyball_8f376453_1:

    # "Things start out pretty relaxed, people hitting the ball around for fun, cracking jokes and making small talk. It doesn't take long before everyone starts taking things much more seriously, and you're even starting to keep score."
    ""

# game/scripts/events/sandbox/pool_party/variants.rpy:515
translate russian pool_party_pool_volleyball_cb133028:

    # "Some people were more enthusiastic than others, and not everybody was so keen on splashing around expending so much energy. . ."
    ""

# game/scripts/events/sandbox/pool_party/variants.rpy:516
translate russian pool_party_pool_volleyball_746fcabf:

    # "They stick around for the sake of the group, but you can tell some would have rather relaxed and saved their energy."
    ""

# game/scripts/events/sandbox/pool_party/variants.rpy:540
translate russian pool_party_pool_basketball_de6aff77:
...
translate russian pool_party_pool_basketball_a3059f97:
...
translate russian pool_party_pool_basketball_f2fed00f:

    # "It's all in good fun, but you obviously can't let the other team win. Afterwards everyone relaxes together in the water, chatting."
    ""

# game/scripts/events/sandbox/pool_party/variants.rpy:556
translate russian pool_party_pool_basketball_a3059f97_1:

    # "Things start out pretty relaxed, people shooting hoops for fun, cracking jokes and making small talk. It doesn't take long before everyone starts taking things much more seriously, and you're even starting to keep score."
    ""

# game/scripts/events/sandbox/pool_party/variants.rpy:557
translate russian pool_party_pool_basketball_cb133028:

    # "Some people were more enthusiastic than others, and not everybody was so keen on splashing around expending so much energy. . ."
    ""

# game/scripts/events/sandbox/pool_party/variants.rpy:558
translate russian pool_party_pool_basketball_746fcabf:

    # "They stick around for the sake of the group, but you can tell some would have rather relaxed and saved their energy."
    ""

# game/scripts/events/sandbox/pool_party/variants.rpy:582
translate russian pool_party_diving_contest_3e39271a:
...
translate russian pool_party_diving_contest_9bc0d9a0:
...
translate russian pool_party_diving_contest_f5c7730d:
...
translate russian pool_party_diving_contest_9bc0d9a0_1:

    # "Simple cannonballs clearly aren't going to cut it, and people have to get creative with flips and twists and twirls to really impress the 'judges.' You're pleasantly surprised at how good some people seem to be at this."
    ""

# game/scripts/events/sandbox/pool_party/variants.rpy:599
translate russian pool_party_diving_contest_cb133028:

    # "Some people were more enthusiastic than others, and not everybody was so keen on splashing around expending so much energy. . ."
    ""

# game/scripts/events/sandbox/pool_party/variants.rpy:600
translate russian pool_party_diving_contest_746fcabf:

    # "They stick around for the sake of the group, but you can tell some would have rather relaxed and saved their energy."
    ""

# game/scripts/events/sandbox/pool_party/variants.rpy:612
translate russian pool_party_never_have_I_ever_e279079b:
...
translate russian pool_party_never_have_I_ever_b4ede902:
...
translate russian pool_party_never_have_I_ever_86d020ac:
...
translate russian pool_party_existential_5a292d6d:
...
translate russian pool_party_existential_f0422292:
...
translate russian pool_party_existential_67a2c2c6:
...
translate russian pool_party_future_fantasies_0b97d11f:
...
translate russian pool_party_future_fantasies_e10906f2:
...
translate russian pool_party_future_fantasies_2c1a6cf0:
