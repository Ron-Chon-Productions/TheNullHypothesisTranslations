...
translate french Jean_quirks_discussion_3ccbc403:

    # ch_Jean "Huh. What kind of stuff?"
    ch_Jean ""

# game/characters/Jean/interactions/quirks.rpy:46
translate french Jean_quirks_discussion_cb1c0cf3:
...
translate french Jean_quirks_discussion_8302f37e:
...
translate french Jean_quirks_discussion_4bd9e94e:
...
translate french Jean_quirks_discussion_93bece79:
...
translate french Jean_quirks_discussion_f77bd4b6:

    # ch_Jean "Some more than others, anyway. . ."
    ch_Jean ""

# game/characters/Jean/interactions/quirks.rpy:64
translate french Jean_quirks_discussion_e61a0879:
...
translate french Jean_quirks_discussion_439b4a6e:
...
translate french Jean_change_quirks_encourage_dominance_b1ca7ff5:
...
translate french Jean_change_quirks_encourage_dominance_080321ec:

    # ch_Jean "I guess I just figured. . ."
    ch_Jean ""

# game/characters/Jean/interactions/quirks.rpy:139
translate french Jean_change_quirks_encourage_dominance_2535cba4:
...
translate french Jean_change_quirks_encourage_dominance_52d9d165:

    # ch_Player "Well. . . I'm not 'other people'."
    ch_Player ""

# game/characters/Jean/interactions/quirks.rpy:145
translate french Jean_change_quirks_encourage_dominance_1708faa8:

    # ch_Jean "No, you definitely are not."
    ch_Jean ""

# game/characters/Jean/interactions/quirks.rpy:157
translate french Jean_change_quirks_discourage_dominance_c281c58d:

    # ch_Jean "Not working for you?"
    ch_Jean ""

# game/characters/Jean/interactions/quirks.rpy:158
translate french Jean_change_quirks_discourage_dominance_5be9186b:

    # ch_Jean "Sure, I can tone it down."
    ch_Jean ""

# game/characters/Jean/interactions/quirks.rpy:163
translate french Jean_change_quirks_discourage_dominance_511109f2:
...
translate french Jean_change_quirks_discourage_dominance_b5422147:
...
translate french Jean_change_quirks_discourage_dominance_999b7a17:

    # ch_Jean "I'll do my best to remember I'm not out in the field then."
    ch_Jean ""

# game/characters/Jean/interactions/quirks.rpy:170
translate french Jean_change_quirks_discourage_dominance_0bdf4997:

    # ch_Player "Thanks."
    ch_Player ""

# game/characters/Jean/interactions/quirks.rpy:182
translate french Jean_change_quirks_encourage_siblings_4d2d794c:
...
translate french Jean_change_quirks_encourage_siblings_f06fe74d:

    # ch_Jean "You think so too? Maybe we could lean into it during. . ."
    ch_Jean ""

# game/characters/Jean/interactions/quirks.rpy:201
translate french Jean_change_quirks_encourage_siblings_156eef6c:
...
translate french Jean_change_quirks_discourage_siblings_a59fdca6:
...
translate french Jean_change_quirks_discourage_siblings_4084f7a5:

    # ch_Player "The 'big sis' thing, can we maybe. . . not?"
    ch_Player ""

# game/characters/Jean/interactions/quirks.rpy:220
translate french Jean_change_quirks_discourage_siblings_61fc140e:

    # ch_Jean "You don't want me looking out for you?"
    ch_Jean ""

# game/characters/Jean/interactions/quirks.rpy:221
translate french Jean_change_quirks_discourage_siblings_5750cbc2:
...
translate french Jean_change_quirks_discourage_siblings_58b3dfa5:

    # ch_Jean "Really?"
    ch_Jean ""

# game/characters/Jean/interactions/quirks.rpy:226
translate french Jean_change_quirks_discourage_siblings_40f2aa4d:

    # ch_Player "Yeah. So when you started getting handsy during dessert. . ."
    ch_Player ""

# game/characters/Jean/interactions/quirks.rpy:231
translate french Jean_change_quirks_discourage_siblings_998ef729:

    # ch_Jean "Oh."
    ch_Jean ""

# game/characters/Jean/interactions/quirks.rpy:236
translate french Jean_change_quirks_discourage_siblings_3427b3bf:

    # ch_Jean "Oh!"
    ch_Jean ""

# game/characters/Jean/interactions/quirks.rpy:241
translate french Jean_change_quirks_discourage_siblings_5188a492:

    # ch_Jean "Oh, wow. . . So we're not going back there for a while!"
    ch_Jean ""

# game/characters/Jean/interactions/quirks.rpy:242
translate french Jean_change_quirks_discourage_siblings_ca8fb08c:

    # ch_Player "Probably a good plan."
    ch_Player ""

# game/characters/Jean/interactions/quirks.rpy:247
translate french Jean_change_quirks_discourage_siblings_04539d10:
...
translate french Jean_change_quirks_discourage_siblings_7572c228:

    # ch_Player "I don't mind that part."
    ch_Player ""

# game/characters/Jean/interactions/quirks.rpy:253
translate french Jean_change_quirks_discourage_siblings_0444a0e0:
